<header class="sticky w-full z-30 top-0 lg:top-6">
  <nav aria-label="Global" class="bg-purple-blue-950/10 mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 lg:rounded-lg shadow-md dark:bg-gray-800/75 lg:backdrop-blur-xs">
