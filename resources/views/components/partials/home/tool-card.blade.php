...
<a href="{{ $url }}" class="group block rounded-lg bg-white p-6 ring-1 ring-slate-200 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl hover:ring-purple-blue-400 dark:bg-slate-900 dark:ring-slate-800 dark:hover:ring-purple-blue-500">
